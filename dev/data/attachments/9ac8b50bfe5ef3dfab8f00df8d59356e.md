...
- Name: specs/smoke-testing/07-join-requests/staff.join-requests.spec.ts >> Co-owner decides a join request >> OWS-002 - a co-owner can approve a pending applicant @OWS-002 @destructive
- Location: e2e/specs/smoke-testing/07-join-requests/staff.join-requests.spec.ts:223:7
          ...
          - generic [ref=e42]:
            - generic [ref=e43]:
              ...
              - link "Messages" [ref=e54] [cursor=pointer]:
                - /url: /dashboard/messages
              - button "52" [ref=e58] [cursor=pointer]
