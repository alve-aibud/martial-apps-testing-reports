          ...
          - generic [ref=f1e38]:
            - generic [ref=f1e39]:
              ...
              - link "Messages" [ref=f1e50] [cursor=pointer]:
                - /url: /dashboard/messages
              - button "16" [ref=f1e54] [cursor=pointer]
            ...
            - generic:
              - generic:
                - button [ref=f1e154] [cursor=pointer]:
                  - heading "Sites" [level=3] [ref=f1e155]
                - button "View all →" [ref=f1e158] [cursor=pointer]
              - generic:
                - button "All Sites" [ref=f1e159] [cursor=pointer]
                - button "Automation Club - Main Site" [ref=f1e164] [cursor=pointer]
                - button "[e2e] Canada TZ - AB (Mountain)" [ref=f1e169] [cursor=pointer]
                - button "[e2e] Canada TZ - BC (Pacific)" [ref=f1e174] [cursor=pointer]
                - button "[e2e] Canada TZ - MB (Central)" [ref=f1e179] [cursor=pointer]
                - button "[e2e] Canada TZ - NL (Newfoundland)" [ref=f1e184] [cursor=pointer]
                - button "[e2e] Canada TZ - NS (Atlantic)" [ref=f1e189] [cursor=pointer]
                - button "[e2e] Canada TZ - ON (Eastern)" [ref=f1e194] [cursor=pointer]
                - button "[e2e] Exam Fixtures Site" [ref=f1e199] [cursor=pointer]
                - button "[e2e] site-owp009 mtrhhjbu" [ref=f1e204] [cursor=pointer]
            - generic:
              - generic:
                - button [ref=f1e209] [cursor=pointer]:
                  - heading "Event Types" [level=3] [ref=f1e210]
                - button "Create" [ref=f1e213] [cursor=pointer]
              - generic:
                - generic: Classes
                - generic: Exams
                - generic: Workshops
                - generic: Socials
                - generic: Tournaments
          - button "Expand sidebar" [ref=f1e231] [cursor=pointer]
          - generic [ref=f1e235]:
            - generic [ref=f1e236]:
              - generic [ref=f1e237]:
                - button "Today" [ref=f1e238] [cursor=pointer]
                - generic [ref=f1e239]:
                  - button [ref=f1e240] [cursor=pointer]
                  - button [ref=f1e243] [cursor=pointer]
                - generic [ref=f1e246]:
                  - heading "Monday, September 7, 2026" [level=2] [ref=f1e247]
                  - generic [ref=f1e248]: Attending · 1 event
              - generic [ref=f1e249]:
                - generic [ref=f1e250]:
                  - button "All teachers" [ref=f1e251] [cursor=pointer]
                  - generic [ref=f1e254]:
                    - button "Teaching" [ref=f1e255] [cursor=pointer]
                    - button "Attending" [ref=f1e256] [cursor=pointer]
                - generic [ref=f1e257]:
                  - button "Day" [ref=f1e258] [cursor=pointer]
                  - button "Week" [ref=f1e259] [cursor=pointer]
                  - button "Month" [ref=f1e260] [cursor=pointer]
            - generic [ref=f1e263]:
              - generic [ref=f1e264]:
                - generic [ref=f1e265]: 6 AM
                - generic [ref=f1e267]: 7 AM
                - generic [ref=f1e269]: 8 AM
                - generic [ref=f1e271]: 9 AM
                - generic [ref=f1e273]: 10 AM
                - generic [ref=f1e275]: 11 AM
                - generic [ref=f1e277]: 12 PM
                - generic [ref=f1e279]: 1 PM
                - generic [ref=f1e281]: 2 PM
                - generic [ref=f1e283]: 3 PM
                - generic [ref=f1e285]: 4 PM
                - generic [ref=f1e287]: 5 PM
                - generic [ref=f1e289]: 6 PM
                - generic [ref=f1e291]: 7 PM
                - generic [ref=f1e293]: 8 PM
                - generic [ref=f1e295]: 9 PM
                - generic [ref=f1e297]: 10 PM
              - generic [ref=f1e317] [cursor=pointer]:
                - generic [ref=f1e318]:
                  - generic [ref=f1e319]: 7:57
                  - generic [ref=f1e320]: + Main sensei
                  - generic [ref=f1e321]: + 2nd
                - generic [ref=f1e322]: "[e2e] owp009-series mtrhhjbu"
                - generic [ref=f1e323]: 7:57 – 8:57 pm
                - generic [ref=f1e324]: "[e2e] site-owp009 mtrhhjbu · [e2e] room mtrhhjhv"
        - button [ref=f1e325] [cursor=pointer]
        - generic [ref=f1e328]:
          - generic [ref=f1e330]:
            - generic [ref=f1e336]:
              - heading "Change Class" [level=1] [ref=f1e337]
              - paragraph [ref=f1e338]: "[e2e] owp009-series mtrhhjbu"
            - button [ref=f1e339] [cursor=pointer]
          - generic [ref=f1e343]:
            - generic [ref=f1e344]:
              - generic [ref=f1e348]:
                - paragraph [ref=f1e349]: Mon, Sep 7 · 7:57 PM–8:57 PM
                - paragraph [ref=f1e350]: "[e2e] room mtrhhjhv"
              - generic [ref=f1e351]: Starts in 2h 58m
            - generic [ref=f1e355]:
              - generic [ref=f1e356]: Recurring class — apply to
              - generic [ref=f1e362]:
                - button "This class" [ref=f1e363] [cursor=pointer]
                - button "This & future" [ref=f1e364] [cursor=pointer]
              - paragraph [ref=f1e365]: Only this class moves to the new time.
            - generic [ref=f1e367]:
              - generic [ref=f1e368]: Class Name *
              - textbox [ref=f1e369]: "[e2e] owp009-series mtrhhjbu"
            - generic [ref=f1e370]:
              - generic [ref=f1e371]: Description
              - textbox [ref=f1e372]
            - generic [ref=f1e373]:
              - generic [ref=f1e374]: New date & time
              - generic [ref=f1e375]:
                - generic [ref=f1e376]:
                  - generic [ref=f1e377]: Date
                  - button "7 Sep 2026" [ref=f1e378] [cursor=pointer]
                - generic [ref=f1e382]:
                  - generic [ref=f1e383]: Start time
                  - button "07:57 PM" [ref=f1e384] [cursor=pointer]
                - generic [ref=f1e389]:
                  - generic [ref=f1e390]: Duration (mins)
                  - generic [ref=f1e391]:
                    - spinbutton [ref=f1e392]: "60"
                    - generic [ref=f1e393]: min
              - paragraph [ref=f1e394]:
                - text: 7:57 PM – 8:57 PM
                - generic [ref=f1e398]: (60 min)
              - generic [ref=f1e399]: No room on this class — availability can't be checked
            - generic [ref=f1e403]:
              - generic [ref=f1e404]:
                - text: From
                - paragraph [ref=f1e405]: Mon, Sep 7 · 7:57 PM – 8:57 PM
              - generic [ref=f1e408]:
                - text: To
                - paragraph [ref=f1e409]: Mon, Sep 7 · 7:57 PM – 8:57 PM
            - generic [ref=f1e410]:
              - generic [ref=f1e411]:
                - text: Reason
                - generic [ref=f1e412]: (optional)
              - textbox "e.g. Room conflict, instructor schedule change..." [ref=f1e413]
            - generic [ref=f1e414]:
              - generic [ref=f1e419]:
                - paragraph [ref=f1e420]: Notify Members
                - paragraph [ref=f1e421]: Send notification to all club members about this change
              - button [ref=f1e422] [cursor=pointer]
          - generic [ref=f1e424]:
            - button "Keep class" [ref=f1e425] [cursor=pointer]
            - button "Save Changes" [ref=f1e426] [cursor=pointer]
  - alert [ref=f1e429]
```
